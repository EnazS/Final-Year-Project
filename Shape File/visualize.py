...
def visualize_community():
    ...
    f_shape = fiona.open('/home/zanesx/Desktop/CrimeRateInferenceWithBigData-master/CrimeRateInference_SourceCode/CrimeRateInference_python/data/Boundaries - Community Areas (Chicago)/geo_export_df4c88b3-2dc9-4983-91a2-aa789fff05c4.shp')
